...
begin
fdquery2.Open('select link_livro from livroslinks where id_livroslinks = 1');
link1.Caption := dbtext2.Caption;
fdquery2.Open('select link_livro from livroslinks where id_livroslinks = 2');
link2.Caption := dbtext2.Caption;
fdquery2.Open('select link_livro from livroslinks where id_livroslinks = 3');
link3.Caption := dbtext2.Caption;
fdquery2.Open('select link_livro from livroslinks where id_livroslinks = 4');
link4.Caption := dbtext2.Caption;
fdquery2.Open('select link_livro from livroslinks where id_livroslinks = 5');
